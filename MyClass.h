...
// Thu Dec  7 10:51:42 2023 by ROOT version 6.30/02
// from TTree Events/Events
// found on file: G-4Jets_HT-40to70_postEE.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           nFatJet;
   UChar_t         FatJet_jetId[2];   //[nFatJet]
   UChar_t         FatJet_nConstituents[2];   //[nFatJet]
   Short_t         FatJet_subJetIdx1[2];   //[nFatJet]
   Short_t         FatJet_subJetIdx2[2];   //[nFatJet]
   Short_t         FatJet_electronIdx3SJ[2];   //[nFatJet]
   Short_t         FatJet_muonIdx3SJ[2];   //[nFatJet]
   ...
   Float_t         FatJet_particleNetWithMass_H4qvsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_HbbvsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_HccvsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_QCD[2];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_TvsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_WvsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNetWithMass_ZvsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD[2];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD0HF[2];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD1HF[2];   //[nFatJet]
   Float_t         FatJet_particleNet_QCD2HF[2];   //[nFatJet]
   Float_t         FatJet_particleNet_XbbVsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNet_XccVsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNet_XggVsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNet_XqqVsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNet_XteVsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNet_XtmVsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNet_XttVsQCD[2];   //[nFatJet]
   Float_t         FatJet_particleNet_massCorr[2];   //[nFatJet]
   ...
   Int_t           nGenJetAK8;
   Float_t         GenJetAK8_eta[2];   //[nGenJetAK8]
   Float_t         GenJetAK8_mass[2];   //[nGenJetAK8]
   Float_t         GenJetAK8_phi[2];   //[nGenJetAK8]
   Float_t         GenJetAK8_pt[2];   //[nGenJetAK8]
   Int_t           nGenJet;
   ...
   Int_t           nSubGenJetAK8;
   Float_t         SubGenJetAK8_eta[4];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_mass[4];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_phi[4];   //[nSubGenJetAK8]
   Float_t         SubGenJetAK8_pt[4];   //[nSubGenJetAK8]
   Int_t           Generator_id1;
   Int_t           Generator_id2;
   ...
   Short_t         IsoTrack_charge[5];   //[nIsoTrack]
   Short_t         IsoTrack_fromPV[5];   //[nIsoTrack]
   ...
   Bool_t          LowPtElectron_convVeto[6];   //[nLowPtElectron]
   UChar_t         LowPtElectron_convWP[6];   //[nLowPtElectron]
   UChar_t         LowPtElectron_lostHits[6];   //[nLowPtElectron]
   Short_t         LowPtElectron_electronIdx[6];   //[nLowPtElectron]
   Short_t         LowPtElectron_photonIdx[6];   //[nLowPtElectron]
   Int_t           LowPtElectron_charge[6];   //[nLowPtElectron]
   Int_t           LowPtElectron_pdgId[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_ID[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_convVtxRadius[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_deltaEtaSC[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_dxy[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_dxyErr[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_dz[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_dzErr[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_eInvMinusPInv[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_energyErr[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_eta[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_hoe[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_mass[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_miniPFRelIso_all[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_miniPFRelIso_chg[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_phi[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_pt[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_ptbiased[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_r9[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_scEtOverPt[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_sieie[6];   //[nLowPtElectron]
   Float_t         LowPtElectron_unbiased[6];   //[nLowPtElectron]
   Float_t         GenMET_phi;
   Float_t         GenMET_pt;
   ...
   UChar_t         Tau_nSVs[5];   //[nTau]
   Short_t         Tau_charge[5];   //[nTau]
   Short_t         Tau_decayModePNet[5];   //[nTau]
   Short_t         Tau_eleIdx[5];   //[nTau]
   Short_t         Tau_jetIdx[5];   //[nTau]
   Short_t         Tau_muIdx[5];   //[nTau]
   Short_t         Tau_svIdx1[5];   //[nTau]
   Short_t         Tau_svIdx2[5];   //[nTau]
   ...
   Float_t         Tau_probDM0PNet[5];   //[nTau]
   Float_t         Tau_probDM10PNet[5];   //[nTau]
   Float_t         Tau_probDM11PNet[5];   //[nTau]
   Float_t         Tau_probDM1PNet[5];   //[nTau]
   Float_t         Tau_probDM2PNet[5];   //[nTau]
   Float_t         Tau_pt[5];   //[nTau]
   Float_t         Tau_ptCorrPNet[5];   //[nTau]
   Float_t         Tau_puCorr[5];   //[nTau]
   Float_t         Tau_qConfPNet[5];   //[nTau]
   ...
   Float_t         Tau_rawPNetVSe[5];   //[nTau]
   Float_t         Tau_rawPNetVSjet[5];   //[nTau]
   Float_t         Tau_rawPNetVSmu[5];   //[nTau]
   Float_t         TkMET_phi;
   Float_t         TkMET_pt;
   Float_t         TkMET_sumEt;
   Int_t           nTrigObj;
   ...
   UChar_t         FatJet_hadronFlavour[2];   //[nFatJet]
   UChar_t         FatJet_nBHadrons[2];   //[nFatJet]
   UChar_t         FatJet_nCHadrons[2];   //[nFatJet]
   Short_t         FatJet_genJetAK8Idx[2];   //[nFatJet]
   UChar_t         GenJetAK8_hadronFlavour[2];   //[nGenJetAK8]
   Short_t         GenJetAK8_partonFlavour[2];   //[nGenJetAK8]
   UChar_t         GenJet_hadronFlavour[18];   //[nGenJet]
   Short_t         GenJet_partonFlavour[18];   //[nGenJet]
   Float_t         GenVtx_t0;
   UChar_t         Jet_hadronFlavour[17];   //[nJet]
   Short_t         Jet_genJetIdx[17];   //[nJet]
   Short_t         Jet_partonFlavour[17];   //[nJet]
   UChar_t         LowPtElectron_genPartFlav[6];   //[nLowPtElectron]
   Short_t         LowPtElectron_genPartIdx[6];   //[nLowPtElectron]
   ...
   UChar_t         SubJet_hadronFlavour[4];   //[nSubJet]
   ...
   TBranch        *b_GenPart_pt;   //!ool_t          L1_QuadJet60er2p5;
   ...
   Bool_t          HLT_AK8PFJet260;TBranch        *b_nGenJet;   //!
   ...
   Bool_t          HLT_Mu12_TrkIsoVVL_Ele23_CalTBranch        *b_nGenJet;   //!
   TBranch        *b_GenJet_eta;   //!
   TBranch        *b_GenJet_mass;   //!
   TBranch        *b_GenJet_phi;   //!
   TBranch        *b_GenJet_pt;   //!oIdL_TrackIdL_IsoVL;
   ...
   Bool_t          HLT_Photon110EB_TightID_TigTBranch        *b_nLHEPart;   //!
   ...
   TBranch        *b_LHEPart_incomingpz;   //!htIso;
   ...
   TBranch        *b_nCorrT1METJet;   //!TBranch        *b_nLHEPart;   //!
   TBranch        *b_LHEPart_pdgId;   //!
   TBranch        *b_LHEPart_status;   //!
   TBranch        *b_LHEPart_spin;   //!
   TBranch        *b_LHEPart_pt;   //!
   ...
   TBranch        *b_LHEPart_phi;   //!
   TBranch        *b_LHEPart_mass;   //!
   TBranch        *b_LHEPart_incomingpz;   //!_HLT_BTagMu_AK4DiJet110_Mu5;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("G-4Jets_HT-40to70_postEE.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("G-4Jets_HT-40to70_postEE.root");
      }
...
void MyClass::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("LfChain->SetBranchAddress("nGenPart", &nGenPart, &b_nGenPart);
   fChain->SetBranchAddress("GenPart_genPartIdxMother", GenPart_genPartIdxMother, &b_GenPart_genPartIdxMother);
   fChain->SetBranchAddress("GenPart_statusFlags", GenPart_statusFlags, &b_GenPart_statusFlags);
   fChain->SetBranchAddress("GenPart_pdgId", GenPart_pdgId, &b_GenPart_pdgId);
   fChain->SetBranchAddress("GenPart_status", GenPart_status, &b_GenPart_status);
   ...
   fChain->SetBranchAddress("GenPart_mass", GenPart_mass, &b_GenPart_mass);
   fChain->SetBranchAddress("GenPart_phi", GenPart_phi, &b_GenPart_phi);
   fChain->SetBranchAddress("GenPart_pt", GenPart_pt, &b_GenPart_pt);1_DoubleEG10_er1p2_dR_Max0p6", &L1_DoubleEG10_er1p2_dR_Max0p6, &b_L1_DoubleEG10_er1p2_dR_Max0p6);
   ...
   fChain->SetBranchAddress("L1_DoubleEG9_er1p2_dR_Max0p7", &L1_DoublfChain->SetBranchAddress("nGenPart", &nGenPart, &b_nGenPart);
   fChain->SetBranchAddress("GenPart_genPartIdxMother", GenPart_genPartIdxMother, &b_GenPart_genPartIdxMother);
   fChain->SetBranchAddress("GenPart_statusFlags", GenPart_statusFlags, &b_GenPart_statusFlags);
   fChain->SetBranchAddress("GenPart_pdgId", GenPart_pdgId, &b_GenPart_pdgId);
   fChain->SetBranchAddress("GenPart_status", GenPart_status, &b_GenPart_status);
   ...
   fChain->SetBranchAddress("GenPart_mass", GenPart_mass, &b_GenPart_mass);
   fChain->SetBranchAddress("GenPart_phi", GenPart_phi, &b_GenPart_phi);
   fChain->SetBranchAddress("GenPart_pt", GenPart_pt, &b_GenPart_pt);eEG9_er1p2_dR_Max0p7, &b_L1_DoubleEG9_er1p2_dR_Max0p7);
